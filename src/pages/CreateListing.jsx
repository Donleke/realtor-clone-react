  ...
  return (
    <main className="max-w-md px-2 mx-auto">
      ...
      <form>
        ...
        <div className="flex mt-6 space-x-6 justify-start mb-6  ">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2 text-xl text-gray-700 bg-white border
               ...
               ease-in-out focus:text-gray focus:bg-white focus:border-slate-600
               text-center"
            />
          </div>
          <div>
        ...
        focus:border-slate-600  "
        />
        <p className="text-lg mt-6 font-medium">Description</p>
        <textarea
          type="text"
          id="description"
          value={description}
          ...
          >
            <div>
              <input
                ...
                border border-gray-500 rounded transition 
